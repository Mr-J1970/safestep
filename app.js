...
if (createAccountForm) {
    ...
    const loadProducts = () => {
        ...
        const products = [
            ...
            { name: "Hearing aids", image: "j.jpg", description: "Rechargeable Hearing Aids for Seniors, Behind-the-Ear Style, Clear Sound Quality, Long Battery Life, Comfortable Fit" },
